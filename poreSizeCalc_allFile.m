...
path2Images = strcat(Folder_Content(1).folder,'\');
...
fileNameExcel = sprintf('%s%s-ResultsSummary',path2Images,currentFolderName);
fileNameMat   = sprintf('%sFullResults',path2Images);
save(fileNameMat,'Results');
 ...
 Title=[ 'numPores    ';'numBigPores ';'meanArea    ';'meanBigPores';...
    ...
    xlswrite(fileNameExcel,Titletable,'A1:H1');
...
Result2print = [[Results.numPores]', [Results.numBigPores]',...
    ...
    xlswrite(fileNameExcel,Result2print,Range);
