...
a.XScale = 'log';
a.YScale = 'log';
title({'CCDF-plot for area of pores','1K PIC hydrogel for different concentrations (adaptive) S2'})
...
a.XScale = 'log';
a.YScale = 'log';
title({'CCDF-plot for area of pores','1K PIC hydrogel 0.25 mg/ml adaptive sample 2'})
xlabel('Pore size (micrometer^2)')
ylabel('CCDF - prob [0-1]')
a.FontSize = 14;
ylim([1e-6 1])
...
a.XScale = 'log';
a.YScale = 'log';
title({'CCDF-plot for area of pores','1K PIC hydrogel 0.5 mg/ml adaptive sample 2'})
xlabel('Pore size (micrometer^2)')
ylabel('CCDF - prob [0-1]')
a.FontSize = 14;
ylim([1e-6 1])
...
a.XScale = 'log';
a.YScale = 'log';
title({'CCDF-plot for area of pores','1K PIC hydrogel 1 mg/ml adaptive sample 2'})
xlabel('Pore size (micrometer^2)')
ylabel('CCDF - prob [0-1]')
a.FontSize = 14;
ylim([1e-6 1])
